...
namespace CombatPokemonConsole
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //START GAME
            //Console.WriteLine("Nombre de pokezgegs dans la liste : " + Data.Pokemons.Count.ToString());

            Console.WriteLine("ici est écrit bulbizarre en anglais : " + Data.Pokemons[0].Name);

            //TRYPARSE LES TYPES PARCE QUE YA DES FDP QU ONT TYPE1=UNTRUC ET TYPE2=NULL VOILA
